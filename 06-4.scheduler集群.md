...
1.13 1.14 版本启动服务出现下面问题

```
no kind "KubeSchedulerConfiguration" is registered for version "componentconfig/v1alpha1" in scheme "k8s.io/kubernetes/pkg/scheduler/apis/config/scheme/scheme.go:2

```
+ 解决办法：componentconfig/v1alpha1 修改为 kubescheduler.config.k8s.io/v1alpha1
